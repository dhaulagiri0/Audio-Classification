...
from models import TriMelspecModel, EnsembleModel, TriSpecModel
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='trimelspecmodel')
    ...
    parser.add_argument('--return_decibels', type=bool, default=True)
